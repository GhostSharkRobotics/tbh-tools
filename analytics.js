...
// 集計の閲覧: https://abacus.jasoncameron.dev/get/tbh-tools-gsr/<page>  (<page>=index / tbh-gem-search / ...)
//           合計: https://abacus.jasoncameron.dev/get/tbh-tools-gsr/all
(function () {
  try {
    var NS = "tbh-tools-gsr";
